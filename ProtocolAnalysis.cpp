...
//            case 1:{
//                size_t size = cal.ExpressCompilation(&protocol,attr.second,buffer);
...
//            std::cout << "  length:" << cal.Compute( this, data.length.c_str());
//        if(!data.times.empty())
//            std::cout << " times:" << cal.Compute( this, data.times.c_str());
